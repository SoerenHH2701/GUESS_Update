...
public class Start extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (db.getSize("questions_and_answers_table") != 0) {
            ...
            db.addQANDA(new DB_Columns_QANDA("Feinstaubbelastung in Deutschland durch den StraÃŸenverkehr eines Monats (t)", "2222", "leicht", "172034", "2148375", "2869535"));
            ...
            db.addQANDA(new DB_Columns_QANDA("Wie viele Minuten muss man ein StrauÃŸenei kochen, bis es hartgekocht ist ?", "40", "mittel", "834269", "1288136", "2903589"));
            ...
            db.addQANDA(new DB_Columns_QANDA("Wie viele Teile Besteck gibt es im WeiÃŸen Haus ?", "13092", "leicht", "870852", "1333098", "3102290"));
            ...
            db.addQANDA(new DB_Columns_QANDA("Wie viele Menschen saÃŸen 2015 in Deutschland im Gefängnis ?", "61872", "leicht", "1133420", "1584294", "2302462"));
            ...
            db.addQANDA(new DB_Columns_QANDA("Wie viele Sterne sieht man von der Erde aus mit dem bloÃŸen Auge ?", "6000", "schwer", "314487", "1765071", "2422794"));
            ...
            db.addQANDA(new DB_Columns_QANDA("Wie groÃŸ ist Michael Jordan (cm)?", "198", "schwer", "558857", "1262889", "2633895"));
